...
For example, you might have a `urls.py.py` that looks something like this:
    ...
    def get_urls(self):
        ...
        for prefix, viewset, basename in self.registry:
            ...
            for route in routes:
                ...
                #   controlled by project's urls.py.py and the router is in an app,
